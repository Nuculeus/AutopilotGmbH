...
function buildFallbackDraft(idea: string): CompanyHqDraftResult {
  ...
  return {
    ...
    profile: {
      ...
      proofTarget: "Erster verifizierter Umsatz in 14 Tagen.",
        ...
        json_schema: {
          ...
          schema: {
            ...
            properties: {
              ...
              budgetCapCents: { type: "number" },
              acquisitionChannel: { type: "string" },
              paymentNode: { type: "string" },
              deliveryNode: { type: "string" },
              autonomyLevel: {
                type: "string",
                enum: ["guided", "semi_auto", "auto"],
              },
            },
          },
        },
